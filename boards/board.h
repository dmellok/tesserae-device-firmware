...
#elif defined(TESSERAE_BOARD_WAVESHARE_1085G)
#  include "waveshare_1085g.h"
...
#elif defined(TESSERAE_BOARD_SEEED_E1001_GRAY_LEGACY)
...
#  include "seeed_xiao_epaper_75_c3.h"
...
#elif defined(TESSERAE_BOARD_M5STACK_PAPERMONO)
#  include "m5stack_papermono.h"
