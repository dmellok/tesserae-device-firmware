 ...
 * more than the original 8; 64 static targets cost ~2 KB of parser state
 * (raised from 32 on 2026-07-26: the first real v2 dashboard truncated
 * mid-document at 32 and its tail sections went dead).
